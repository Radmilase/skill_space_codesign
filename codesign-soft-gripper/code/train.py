...
def main():
    args = parse_args()
    print("START TRAIN")
    print("curr_dir:", os.path.dirname(os.path.abspath(__file__)))
    print("data_gen exists:", os.path.exists(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../data_gen")))
    print("data_gen list:", os.listdir(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../data_gen"))[:10])
