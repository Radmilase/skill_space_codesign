...
В каждом эксперименте измеряются численные метрики качества. Эти метрики агрегируются сначала на уровне отдельного навыка, а затем по всему набору навыков, что позволяет оценить, какие навыки данная морфология поддерживает устойчиво и насколько чувствительна она к изменению условий.Полученная оценка будет использоваться для co-design. **Морфологии будут сравниваться не по качеству выполнения отдельных сценариев, а по количеству манипуляционных навыков, которые они способны выполнять устойчиво, и по степени сохранения этих навыков при изменении условий взаимодействия.**
